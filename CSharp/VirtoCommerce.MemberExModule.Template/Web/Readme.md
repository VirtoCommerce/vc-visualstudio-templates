...
Short overview of what the new module extension is.
...
Short description of the new module extension functional requirements.

## Scenarios

List of scenarios that the new module extension implements
...
Web API documentation for base module and module extension can be accessed by following the links bellow:
<https://link-to-base-module-swager-api>
<https://link-to-module-extension-swager-api>
...
[Base module description](base-module-readme.md)
